...
if __name__ == "__main__":
    ...
    for i in range(num_digits):
        ...
        utils.write_image_to_file("images/most-prototytpical"+str(i)+".png", test_images[most_prototypical[i][0]])

    print("\nLeast Prototypical: (index, prior, truth label, classifier output)")
    for i in range(num_digits):
        print(least_prototypical[i])
        utils.write_image_to_file("images/least-prototytpical"+str(i)+".png", test_images[least_prototypical[i][0]])
